            ...
            <td>
                ...
                <div style="font-family: Verdana, Arial, sans-serif;">
                    ...
                    <div align="justify" style="font-size: 12px; color: #333333">
                        ...
                        <p>To reset your password, type the full email address you use to sign in to your Maali Account.</p>
                        <br>
                        ...
                        <p>If you have forgotten user primary email address(username) then you will have to create a new Maali Account.</p>
                    </div>
                    <br>
                </div>
            </td>

...
class TestController {
    ...
    def save() {
        ...
        if (!testInstance.save(flush: true)) {
            flash.message = message(code: 'website.com.officegain.userCreationFailed', args: [message(code: 'test.label', default: 'Test'), testInstance.id])
            render(view: "create", model: [testInstance: testInstance])
            return
        }

        flash.message = message(code: 'website.com.officegain.userCreationSuccessful', args: [message(code: 'test.label', default: 'Test'), testInstance.id])

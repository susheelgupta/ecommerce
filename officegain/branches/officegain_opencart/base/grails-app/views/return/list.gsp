...
<div id="content">
    <div class="breadcrumb">
        ...
        <a href="${request.contextPath}/return">Product Returns</a>
    </div>

    <div class="box">
        <div class="heading">
            <h1><img src="${resource(dir: 'images', file: 'order.png')}" alt=""/> Product Returns</h1>

            <div class="buttons">
                <a href="${request.contextPath}/return/create" class="button">Insert</a>
        ...
        <div class="content">
            <form action="${request.contextPath}/return/delete" method="post" id="deleteForm" name="productForm">
                ...
                <table class="list">
                    ...
                    <tr class="filter">
                        <td></td>
                        <td><input type="text" name="filter_name" value="" size="4"></td>
                        <td><input type="text" name="filter_name1" value="" size="4"></td>
                        <td><input type="text" name="filter_mode2" value="" size="8"></td>
                        <td align="left"><input type="text" name="filter_price" value="" size="8"/></td>
                        <td align="right"><input type="text" name="filter_quantity" value=""
                                                 style="text-align: right;"/>
                        </td>
                        <td><select name="filter_status">
                            <option value="*"></option>
                            <option value="">Awating Products</option>

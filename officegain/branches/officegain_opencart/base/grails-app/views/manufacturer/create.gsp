...
<div id="content">
    ...
    <div class="box">
        <div class="heading">
            <h1><img src="${resource(dir: 'images', file: 'shipping.png')}" title="Manufacturer"
                     onclick="location = '${request.contextPath}/manufacturer'"/> Manufacturer</h1>
                ...
                <div id="tab-general">
                    <table class="form">
                        <tr>
                            ...
                            <td><input type="text" name="name" value="" size="100"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Stores</td>
                        ...
                        <tr>
                            <td>Sort Order:</td>
                            <td><input type="text" size="3" value="" name="sortOrder"/>
                            </td>
                        </tr>
                    </table>
                </div>

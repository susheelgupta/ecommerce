...
<div id="content">
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <g:form name="updateForm" method="post" action="update" controller="voucher">
                <g:hiddenField name="id" id="id" value="${voucherInstance.id}"/>
                <div id="tab-general">
                    <table class="form">
                        <tbody><tr>
                            <td><span class="required">*</span> Code:<br><span
                                    class="help">The code the customer enters to activate the voucher.</span></td>
                            <td><input type="text" value="${voucherInstance?.code}" name="code">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="required">*</span> From Name:</td>
                            <td><input type="text" value="${voucherInstance?.fromName}" name="fromName">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="required">*</span> From E-Mail:</td>
                            <td><input type="text" value="${voucherInstance?.fromEmail}" name="fromEmail">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="required">*</span> To Name:</td>
                            <td><input type="text" value="${voucherInstance?.toName}" name="toName">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="required">*</span> To E-Mail:</td>
                            <td><input type="text" value="${voucherInstance?.toEmail}" name="toEmail">
                            </td>
                        </tr>
                        <tr>
                            <td>Theme:</td>
                        ...
                        <tr>
                            ...
                            <td><g:textArea rows="5" cols="40" name="message"
                                            value="${voucherInstance?.message}"/></td>
                        </tr>
                        <tr>
                            <td>Amount:</td>
                            <td><input type="text" value="${voucherInstance?.amount}" name="amount">
                            </td>
                        </tr>
                        <tr>
                            <td>Status:</td>

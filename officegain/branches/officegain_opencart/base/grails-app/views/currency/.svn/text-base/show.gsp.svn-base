...
<div id="content">
    ...
    <div class="box">
        ...
        <div class="content">
            <g:form name="updateForm" method="post" action="update" controller="currency">
                <g:hiddenField name="id" id="id" value="${currencyInstance.id}"/>
                <div id="tab-general">
                    <table class="form">
                        <tr>
                            <td><span class="required">*</span> Currency Title</td>
                            <td><input type="text" value="${currencyInstance?.title}" name="title"></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" value="${currencyInstance?.code}" name="code"></td>
                        </tr>
                        <tr>
                            <td>Symbol Left:</td>
                            <td><input type="text" value="${currencyInstance?.symbolLeft}" name="symbolLeft"></td>
                        </tr>
                        <tr>
                            <td>Symbol Right:</td>
                            <td><input type="text" value="${currencyInstance?.symbolRight}" name="symbolRight"></td>
                        </tr>
                        <tr>
                            <td>Decimal Places:</td>
                            <td><input type="text" value="${currencyInstance?.decimalPlace}" name="decimalPlace"></td>
                        </tr>
                        <tr>
                            <td>Value:<br><span class="help">Set to 1.00000 if this is your default currency.</span>
                            </td>
                            <td><input type="text" value="${currencyInstance?.value}" name="value"></td>
                        </tr>
                        <tr>
                            <td>Status:</td>
                            <td>
                                <g:if test="${currencyInstance?.status}">
                                    <select name="status">

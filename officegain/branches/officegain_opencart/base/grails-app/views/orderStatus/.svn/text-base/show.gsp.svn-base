    ...
    <div class="box">
        <div class="heading">
            ...
            <div class="buttons">
                ...
                <a class="button" onclick="location = '${request.contextPath}/orderStatus'">Cancel</a></div>
        </div>

        <div class="content">
            <g:form name="updateForm" method="post" action="update" controller="orderStatus">
                <g:hiddenField name="id" id="id" value="${orderStatusInstance.orderStatusId}"/>
                <div id="tab-general">
                    <table class="form">
                        <tr>
                            <td><span class="required">*</span> Order Status Name:</td>
                            <td><input type="text" value="${orderStatusInstance?.name}" name="name">

                    ...
                    <div id="language1" style="display: block;">
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td><g:textArea rows="5" cols="40" name="metaKeyword"/></td>
                            </tr>
                            <tr>
                                <td>Description:</td>
                                <td><g:textArea rows="5" cols="40" id="description1" name="description"/></td>
                                <script type="text/javascript">
                    ...
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td><div class="image"><img id="thumb" alt=""
                                ...
                                <input type="file" id="image" value="" name="image"></div></td>
                        </tr>
                        <tr>
                            <td>Top:<br><span
                        ...
                        <tr>
                            ...
                            <td><input type="text" size="2" value="" name="column"/></td>
                        </tr>
                        <tr>
                            <td>Sort Order:</td>
                            <td><input type="text" size="2" value="" name="sortOrder"/></td>
                        </tr>
                        <tr>
                            <td>Status:</td>

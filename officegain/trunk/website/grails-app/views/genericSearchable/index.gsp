<%@ page import="grails.plugin.searchable.internal.util.StringQueryUtils; com.officegain.enigma.website.WebsiteUtil; com.officegain.enigma.base.Product" %>
<!doctype html>
<html>
<head>
...
<div style="float:none">
    <div class="ygtv-highlight"
        ...
        <script type="text/javascript">
            function getProducts(id) {
                var sUrl = "/website/product/list/" + id;
                ...
                var callback = {
                    success:function (o) {
                        ...
                        $(productImageMap).each(function () {
                            $('#productTable >tbody').append('<tr><td>' + this.product.name + '</td><td>' + this.product.price + '<img height=25 weight=39 src=' + this.imageUrl + ' />' + '</td><td>' + this.product.quantity + '</td><td>' + this.product.weight + '</td></tr>');
                        });
                    },
                    failure:function (o) {
    ...
    <div id="mydiv" style="float:left; width:80% ">
        ...
        <div class="pagination">
            <g:paginate controller="GenericSearchable" action="index" total="${searchResult.total}"
                        params="[q: params.q]"/>
        </div>
    </div>
</div>
